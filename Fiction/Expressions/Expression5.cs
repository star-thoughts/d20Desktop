...
namespace Fiction.Expressions
{
	...
	public class Expression<TResult, T1, T2, T3, T4> : ParameterExpression<TResult>
	{
		#region Constructors
		/// <summary>
		...
		public Expression(string expressionName,
			...
			: base(expressionName, expression, parameterInfo, parameter2Info, parameter3Info, parameter4Info)
		{
		}
		#endregion
		#region Properties
		...
		public TResult? Call(T1 param1, T2 param2, T3 param3, T4 param4)
		{
			...
			return (TResult?)Invoke(new object?[] { param1, param2, param3, param4 });
		}
		#endregion
	}
}
