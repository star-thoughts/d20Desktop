...
namespace Fiction.Expressions
{
	...
	public class Expression<TResult, T1, T2, T3> : ParameterExpression<TResult>
	{
		#region Constructors
		/// <summary>
		...
		public Expression(string expressionName, string expression, ExpressionParameter parameterInfo, ExpressionParameter parameter2Info, ExpressionParameter parameter3Info)
			: base(expressionName, expression, parameterInfo, parameter2Info, parameter3Info)
		{
		}
		#endregion
		#region Properties
